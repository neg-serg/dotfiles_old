...
Neg_kb.WMPlex_toplevel = {
    ...
    kpress("M4+w",     "app.byinstance_withtag('/usr/bin/firefox||firefox-nightly', 'Firefox','Navigator',nil,'www')"),
    ...
    submap("M1+E",{
        ...
        kpress("l",    "radare2(_)"),
        kpress("m",    "app.byinstance('BROWSER=firefox /bin/urxvtc -name mutt -e mutt', 'URxvt', 'mutt')"),
...
Neg_kb.WScreen = {
    submap("M1+E", {
            kpress("Ct+A", "ioncore.goto_activity()"),
            kpress("Ct+t", "ioncore.tagged_clear()"),
            }),
