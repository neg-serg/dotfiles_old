...
Neg_kb.WMPlex_toplevel = {
    ...
    kpress("M4+w",     "app.byinstance_withtag('/usr/bin/firefox-beta||/usr/bin/firefox||firefox-nightly', 'Firefox','Navigator',nil,'www')"),
    ...
    kpress("M4+c",     "notioncore.exec_on(_, 'sh ~/bin/clip')"),
