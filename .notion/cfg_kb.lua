...
Neg_kb.WMPlex_toplevel = {
    ...
    --[[ SCRATCHPADS  ]]--------------------------------
    --------------------
    kpress("M4+d",       "console(ioncore.current())"),
    kpress("M4+p",       "named_scratchpad(ioncore.current(), 'float2')"),
    kpress("M4+F",       "ncmpcpp(ioncore.current())"),
    ...
    submap("M1+E",{
        ...
        kpress("l",    "radare2(notioncore.current())"),
        ...
        kpress("Sh+g", "gdb(notioncore.current())"),
        ...
        kpress("Sh+r", "ranger(notioncore.current())"),
