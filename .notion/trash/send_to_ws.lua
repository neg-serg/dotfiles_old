...
defbindings("WMPlex", {
    --submap(META.."K", {
	    ...
	    kpress(META.."Control+1", "send_to_ws(_sub, 0, true)"),
	    kpress(META.."Control+2", "send_to_ws(_sub, 1, true)"),
	    kpress(META.."Control+3", "send_to_ws(_sub, 2, true)"),
	    kpress(META.."Control+4", "send_to_ws(_sub, 3, true)"),
	    kpress(META.."Control+5", "send_to_ws(_sub, 4, true)"),
	    kpress(META.."Control+6", "send_to_ws(_sub, 5, true)"),
	    kpress(META.."Control+7", "send_to_ws(_sub, 6, true)"),
	    kpress(META.."Control+8", "send_to_ws(_sub, 7, true)"),
	    kpress(META.."Control+9", "send_to_ws(_sub, 8, true)"),
	    kpress(META.."Control+0", "send_to_ws(_sub, 9, true)"),
