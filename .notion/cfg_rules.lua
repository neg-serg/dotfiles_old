...
defwinprop({class="brave",transient_mode="off",transient_mode="off",jumpto=true,target="web",tag="www"})
...
defwinprop({class="skypeforlinux",jumpto=false,winlist_ignore=true,transient_mode="off",target="im",scratchpad="true"})
...
defwinprop({class="Awf-gtk3",jumpto=true,winlist_ignore=true,transient_mode="off",winlist_ignore=true,target="float",scratchpad="true"})
