...
defwinprop{class="Crossover",target="wine",transient_mode="off",jumpto=true,tag="virt",float=true}
defwinprop{class="Wine",target="wine",transient_mode="off",jumpto=true,tag="virt",float=true}
defwinprop{class="*.exe",target="wine",transient_mode="off",jumpto=true,tag="virt",float=true}
defwinprop{class="explorer.exe",target="wine",transient_mode="off",jumpto=true,tag="virt",float=true}
...
defwinprop{instance="gcolor2",winlist_ignore=true,transient_mode="off",float=true}
...
defwinprop{class="Anamnesis",winlist_ignore=true,transient_mode="off",target="float2",jumpto=true}
