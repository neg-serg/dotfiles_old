...
defwinprop{class="Icecat",role="www",transient_mode="off",jumpto="on",target="web",lazy_resize=true,tag="www"}
defwinprop{class="Navigator",role="www",transient_mode="off",jumpto="on",target="web",lazy_resize=true,tag="www"}
