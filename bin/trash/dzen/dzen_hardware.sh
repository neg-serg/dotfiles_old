...
cpu_bar_total=`$(pwd)/bar_cpu.sh 0`
cpu_bar_0=`$(pwd)/bar_cpu.sh 1`
cpu_bar_1=`$(pwd)/bar_cpu.sh 2`
cpu_bar_2=`$(pwd)/bar_cpu.sh 3`
cpu_bar_3=`$(pwd)/bar_cpu.sh 4`

mem_bar=`$(pwd)/bar_ram_lg.sh`

sda_bar=`$(pwd)/bar_disk.sh /dev/sda`
sdb_bar=`$(pwd)/bar_disk.sh /dev/sdb`
