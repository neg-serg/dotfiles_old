...
maildir_path="$HOME/.mail/gmail" # Path to Maildir root.
...
parse_send() {
	...
	local subject=$(/home/neg/bin/scripts/email_parse.py --subject "$mailfile")
	local from=$(/home/neg/bin/scripts/email_parse.py --from "$mailfile")
	local body=$(/home/neg/bin/scripts/email_parse.py --body "$mailfile")
