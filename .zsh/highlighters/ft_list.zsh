    ...
    ftype-tdesktop-theme   fg=5,bold
    ftype-tdesktop-pallete fg=5,bold
    ftype-attheme          fg=5
    ftype-vim              fg=221
    ...
    ftype-Xauthority       fg=4,bold
    ftype-xinitrc          fg=4,bold
    ftype-Xmodmap          fg=4
