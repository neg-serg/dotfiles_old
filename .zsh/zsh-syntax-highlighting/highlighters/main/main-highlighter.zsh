    ...
    if $new_expression; then
     ...
     if [[ -n ${(M)ZSH_HIGHLIGHT_TOKENS_PRECOMMANDS:#"$arg"} ]]; then
      ...
      case $arg in
        ...
        *.(bz2|7z|rar|gz|tar|tar.gz|tar.xz|tar.lrz|zip|xz|apk|arj|deb)) style=$ZSH_HIGHLIGHT_STYLES[fclass-archive];;
        *.part)        style=$ZSH_HIGHLIGHT_STYLES[ftype-part];;
        *.(iso|img|mdf|nrg|cdi|qcow|qcow2)) style=$ZSH_HIGHLIGHT_STYLES[fclass-image];;
        ...
        *.(xpm|jpeg|jpg|JPG|bmp|png)) style=$ZSH_HIGHLIGHT_STYLES[fclass-raster];;
        ...
        *.(pcap|cap|dmp)) style=$ZSH_HIGHLIGHT_STYLES[filetclass-tcpdump];;
        ...
        *.(mkd|markdown|md|tex|textile|owl|n3|rc|cfg|dat|xml|yml|ini|nfo|rdf|txt|etx|properties)) style=$ZSH_HIGHLIGHT_STYLES[fclass-text];;
        ...
        *.(conf|part|bak|dump|swp|swap|tmp|old|un~)) style=$ZSH_HIGHLIGHT_STYLES[fclass-trash];;
