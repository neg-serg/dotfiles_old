...
you should place you code here."
  ...
  (define-key evil-insert-state-map "\C-e" 'end-of-line)
   ...
   (evil-rsi-mode)
   ;;---------------------------------------------------------------------------
   (set-variable 'ycmd-server-command '("python2" "/home/neg/.vim/bundle/YouCompleteMe/third_party/ycmd/ycmd"))
   (setq ycmd-extra-conf-whitelist '("~/src/*"))
   (set-variable 'ycmd-global-config "/home/neg/.vim/ycm_extra_conf.py")
   (setq ycmd-force-semantic-completion t)

   (setq powerline-default-separator 'arrow)
   ; disable helm for lusty
   (helm-mode 0)
   (evil-leader/set-key "l" 'lusty-file-explorer)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:foreground "#1f1f1f" :background "#fee7d8")) (((class color) (min-colors 256)) (:foreground "#1f1f1f" :background "black"))))
 '(company-tooltip-common ((t (:foreground "#990016" :background "#fdddc9"))))
 '(company-tooltip-common-selection ((t (:background "#303030" :foreground "#1ce700" :weight bold :underline t)))))
(setq powerline-default-separator 'arrow)
